...
const normalizeFilters = (filters) => {
    ...
    if (platform === "Zepto") {
        return `https://react-api-script.onrender.com/bunge/update-rule?rule_id=${ruleData.rule_id}&platform=${platform}`;
    } else if (platform === "BigBasket") {
        return `http://react-api-script.onrender.com/bunge/update-rule?platform=${platform}&rule_id=${ruleData.rule_id}`;
    }
    return "";
};
